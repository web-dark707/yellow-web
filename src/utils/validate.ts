...
// 日期格式 ：YYYY-MM-DD，YYYY/MM/DD，YYYY-MM-DD HH:MM，YYYY/MM/DD HH:MM，YYYY-MM-DD HH:MM:SS，YYYY/MM/DD HH:MM:SS
export const isDateTime =
    /^\d{4}[-/](0[1-9]|1[0-2])[-/](0[1-9]|[12][0-9]|3[01])( ([01]\d|2[0-3]):([0-5]\d)(:([0-5]\d))?)?$/;

// 可以带点的数字
export const isWithDotNumber = /^\d+\.?\d*$/;

// 可以带点的数字，最多4位小数。
export const isWithDotNumberMax4 = /^(0|[1-9]\d*)(\.\d{0,4})?$/;

//正整数，不包含0
export const isPositiveIntegerHaveZero = /^\+?[0-9]\d*$/;
